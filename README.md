...
The Admin FAQ is at [`pairwise-v4/faq/`](https://learning.voyage/courses/pairwise-v4/faq/). Same password as the course. A short bar on the course home links to it. Mostly pay, Hubstaff, and login.
